...
//******** Entorn bàsic VS2022 MULTIFINESTRA amb OpenGL 3.3+, interfície MFC i llibreries GLM
...
BEGIN_MESSAGE_MAP(CEntornVGIView, CView)
	...
	ON_UPDATE_COMMAND_UI(ID_OBJECTE_ARC, &CEntornVGIView::OnUpdateObjecteArc)
		...
		ON_COMMAND(ID_PIEZAS_PEON, &CEntornVGIView::OnPiezasPeon)
		ON_COMMAND(ID_PIEZAS_GRUPO_PEONES, &CEntornVGIView::OnPiezasGrupoPeones)
		END_MESSAGE_MAP()
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Funcion llamada al pulsar la pestaña "PruebaPiezas>Peon". Asigna el valor constante PAWN a la variable "objeto",
// para que al dibujar la escena se dibuje solo un peon. 
// 
// Activa el contexto OpenGL, limpia el VAO, asigna un color por defecto (podria modificarse), activa el contexto OpenGL y 
// realiza la llamada para dibujar la escena.
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CEntornVGIView::OnPiezasPeon()
{
	// TODO: Agregue aquí su código de controlador de comandos
	objecte = PAWN;
	...
	// Precargamos las partes de la pieza
	Set_VAOList(BASE1_PIEZA, loadgluDisk_EBO(0.0, 45.0, 10, 1));		// Cargamos parte 1 de la base en posicion BASE1_PIEZA

	Set_VAOList(BASE2_PIEZA, loadgluCylinder_EBO(45.0f, 50.0f, 7.5f, 10, 1));		// Cargamos parte 2 de la base en posicion BASE2_PIEZA

	Set_VAOList(BASE3_PIEZA, loadgluCylinder_EBO(50.0f, 50.0f, 8.0f, 10, 1));		// Cargamos parte 3 de la base en posicion BASE3_PIEZA

	Set_VAOList(BASE4_PIEZA, loadgluCylinder_EBO(50.0f, 30.0f, 10.0f, 10, 1));		// Cargamos parte 4 de la base en posicion BASE4_PIEZA

	Set_VAOList(PEON_TRONCO1, loadgluCylinder_EBO(30.0f, 25.0f, 15.0f, 10, 1));		// Cargamos parte 1 del tronco del peon

	Set_VAOList(PEON_ANILLO, loadCilindre_VAO(32.5f, 27.5f, 15.0f, 10, 1));		// Genera VAO del cilindro

	Set_VAOList(PEON_TRONCO2, loadgluCylinder_EBO(20.0f, 14.16f, 17.5f, 10, 1));		// Genera EBO del cilindro

	Set_VAOList(PEON_TRONCO3, loadgluCylinder_EBO(14.16f, 14.16f, 4.0f, 10, 1));		// Genera EBO del cilindro
	...
	//Inicializacion de posiciones de los peones
	//
	//for (int i = 0; i < 10/*files*/; i++)
	//{
	//	for (int j = 0; j < 10/*peons totals*/; j++)
	//	{
	//		//Posición relativa a la que se colocara el peon
	//		posiciones_peones.push_back(glm::vec3(i * 50.0f - (10 - i) * 50.0f, j * 50.0f - (10 - j) * 50.0f, 0.0f));
	//	}
	//}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Funcion llamada al pulsar la pestaña "PruebaPiezas>Grupo peones". Asigna el valor constante CHESSBOARD a la variable "objeto",
// para que al dibujar la escena se dibujen los vertices del tablero y sus piezas. 
// 
// Activa el contexto OpenGL, limpia el VAO, asigna un color por defecto (podria modificarse), activa el contexto OpenGL y 
// realiza la llamada para dibujar la escena.
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CEntornVGIView::OnPiezasGrupoPeones()
{
	// TODO: Agregue aquí su código de controlador de comandos
	objecte = CHESSBOARD;
	...
	// Precargamos las partes de las piezas
