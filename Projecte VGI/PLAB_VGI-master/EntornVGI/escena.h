...
//Funciones anadidas para nuestro trabajo practico:
void Pawn(GLint shaderId, glm::mat4 MatriuVista, glm::mat4 MatriuTG, bool sw_mat[5], std::vector<vec3> position);
